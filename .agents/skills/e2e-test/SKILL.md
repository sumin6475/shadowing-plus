...
<!-- Source: coleam00/ai-coding-summit-workshop-2 .Codex/skills/e2e-test/SKILL.md — adopted 2026-07-10, near-verbatim (subagent-tool naming modernized; report/screenshot paths stay at project root as a deliberate exception to the .agents/ artifact rule). External dependency: agent-browser CLI (Vercel Labs, npm i -g agent-browser); the companion agent-browser skill is its CLI reference. -->
