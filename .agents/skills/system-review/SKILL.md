...
- Bad divergence reveals unclear requirements or missing context → improve AGENTS.md / reference docs
...
- The skills that drove the run: `.Codex/skills/plan-feature/SKILL.md` and `.Codex/skills/execute/SKILL.md` (to propose edits against their actual text)
- The project's current AI layer: `AGENTS.md` (root and per-area), On-Demand Context docs
- **`.Codex/Codex-md-review.md` if it exists** — the auto-reflector's pending draft. Fold its suggestions into your proposals (keep, sharpen, or reject each), then note it as adjudicated.
...
- [ ] Used documented patterns (AGENTS.md)
...
- **[PROJECT]** — this project's own AI layer (its AGENTS.md, its docs). Apply here after approval.
...
## Reflector Draft
[Adjudicated .Codex/Codex-md-review.md: which suggestions were folded in (as which proposal #),
...
3. Delete `.Codex/Codex-md-review.md` (its content now lives in this review)
