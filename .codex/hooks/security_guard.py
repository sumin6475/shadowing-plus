...
Source: coleam00/harness-engineering-demo .claude/hooks/security_guard.py —
adopted 2026-07-10 near-verbatim (platform-independent as written; defense in
depth with the settings.json permissions deny list).
"""
import json
import re
import sys
