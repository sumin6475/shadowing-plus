...
<!-- Source: coleam00/habit-tracker .Codex/commands/validation/code-review.md (review philosophy, context gathering, 5 analysis categories, verify-issues-real, severity output); scope-parsing table, severity taxonomy, and report shape from coleam00/ai-transformation-workshop .Codex/commands/review.md; holdout principle from coleam00/dark-factory-experiment FACTORY_RULES.md — adapted 2026-07-10 -->
...
- Read AGENTS.md (and per-area AGENTS.md files) for the project's standards
...
5. **Standards adherence** — AGENTS.md rules, existing patterns, logging/testing standards
