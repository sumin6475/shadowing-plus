...
<!-- Source: coleam00/habit-tracker .Codex/commands/core_piv_loop/prime.md; read-only guard block from coleam00/remote-agentic-coding-system .agents/commands/prime.md — adapted 2026-07-10 -->
...
- `AGENTS.md` (and per-area AGENTS.md files if this is a monorepo)
...
- Any architecture documentation, plus the On-Demand Context docs relevant to the upcoming work (AGENTS.md's table says which)
