...
<!-- Source: coleam00/habit-tracker .claude/commands/validation/code-review-fix.md (deliberately minimal two-argument shape) — adapted 2026-07-10 -->
...
4. After all fixes, re-run the project's Validation-contract commands from CLAUDE.md (the same gauntlet `/validate` runs — you can't invoke `/validate` itself; it's human-invoked) and confirm nothing regressed.
