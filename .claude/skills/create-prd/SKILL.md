...
<!-- Source: coleam00/ai-transformation-workshop .claude/commands/prd-interactive.md (lean core template, staged question gates, TBD-over-invention) merged with coleam00/habit-tracker .claude/commands/create-prd.md (comprehensive sections, attached as extensions; Executive Summary/Mission/Appendix intentionally slimmed into the core) — adapted 2026-07-10 -->
...
{/create-rules to derive the project's CLAUDE.md, research spike, or /plan-feature for the first feature}
```
